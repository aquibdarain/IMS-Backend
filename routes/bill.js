...
router.post('/generateReport',/*auth.authenticateToken,*/(req,res)=>{
    ...
    var query1 = "insert into bill (name,uuid,email,contactNumber,paymentMethod,total,productDetails) values(?,?,?,?,?,?,?)";
    connection.query(query1,[orderDetails.name,generateUuid,orderDetails.email,orderDetails.contactNumber,orderDetails.paymentMethod,orderDetails.totalAmount,orderDetails.productDetails,res.locals.email],(err,results)=>{
...
router.get('/getBills',/*auth.authenticateToken,*/(req,res,next)=>{
    var query2 = "select * from bill order by id DESC"
...
router.delete('/delete/:id',(req,res,next)=>{
    ...
    var query3= "delete from bill where id=?";
